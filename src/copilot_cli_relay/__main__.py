"""Run with `python -m copilot_cli_relay` for local (host) debugging.
...
def main() -> None:
    ...
    uvicorn.run("copilot_cli_relay.server:app", host=host, port=s.proxy_port, log_level=s.log_level)
